"""Convert a historical Oracle IVQR CSV to the thesis-ready schema."""
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("input", type=Path, help="historical wide Oracle CSV")
    parser.add_argument("output", type=Path, help="new clean Oracle CSV")
    return parser.parse_args()


def main() -> None:
    args = _parse_args()
    summary = clean_oracle_results_csv(args.input, args.output)
