"""Create thesis-ready CSV tables from aggregated or raw simulation results."""
...
from ivqr_sim.reporting.tables import load_summary, write_tables
from ivqr_sim.simulation.aggregate import aggregate_results_file


def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create thesis-ready IVQR result tables.")
    parser.add_argument("--input", default=None, help="Aggregated summary CSV.")
    parser.add_argument("--raw-input", default=None, help="Raw estimator-level result CSV.")
    parser.add_argument(
        "--summary-output",
        default=None,
